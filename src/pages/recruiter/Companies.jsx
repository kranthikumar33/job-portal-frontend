          ...
          {companies.map((company) => (
            ...
            >
              ...
              <div className="flex gap-2">
                <button
                  onClick={() =>
                    navigate(`/recruiter/companies/edit/${company._id}`)
                  }
                  className="text-sm font-medium bg-gray-50 hover:bg-gray-100 text-gray-700 px-4 py-2 rounded-lg transition-colors"
                >
                  Edit
                </button>
                <button
